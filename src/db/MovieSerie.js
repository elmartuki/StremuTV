export const movieSerieFullList = [
  ...
  {
    id: 713,
    nombre: "AI: Artificial Intelligence",
  ...
  {
    id: 1003,
    nombre: "Las crónicas de Narnia: El león, la bruja y el armario",
